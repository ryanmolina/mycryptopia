<?php
class PMC_Shortcode_Widget extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'pmc_shortcode_widget', 'description' => __('Supports shortcodes, text, HTML.', 'cryptocurrency'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('shortcode-widget', __('PMC Shortcode Widget', 'cryptocurrency'), $widget_ops, $control_ops);
	}
