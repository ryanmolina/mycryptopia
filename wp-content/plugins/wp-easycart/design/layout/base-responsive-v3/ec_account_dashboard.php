<div id="ec_account_dashboard">
    ...
    <div class="ec_account_left">
        ...
        <?php foreach( $this->downloads as $download ){ 
			...
			$order_item = new ec_orderdetail( $download )
		?>
        
        <div class="ec_account_download_line">
        
        	<div class="ec_account_download_line_title">
            	<a href="<?php echo $order_item->get_download_link( ); ?>" target="_blank" onclick="update_download_count( '<?php echo $order_item->orderdetail_id; ?>' );"><?php echo $download->title; ?></a>
            </div>
