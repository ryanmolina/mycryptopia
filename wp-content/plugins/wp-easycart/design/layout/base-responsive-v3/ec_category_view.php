...
<div class="ec_category_li" style="width:<?php echo (100/$columns); ?>%;">
	<div class="ec_category_view_image">
    	<a href="<?php echo $category->get_category_link( ); ?>"><img src="<?php echo $category->get_image( ); ?>" alt="<?php echo $category->options->category_name; ?>" /></a>
    </div>
    <div class="ec_category_view_data">
    	<h3><a href="<?php echo $category->get_category_link( ); ?>"><?php echo $category->options->category_name; ?></a></h3>
        ...
        <ul>
			...
			?>
        	<li><a href="<?php echo $child->get_category_link( ); ?>"><?php echo $child->options->category_name; ?></a></li>
            <?php } ?>
        </ul>
        <?php }?>
    </div>
