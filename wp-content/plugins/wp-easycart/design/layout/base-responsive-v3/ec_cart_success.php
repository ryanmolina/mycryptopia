...
<p class="ec_cart_success_continue_shopping_button">
	...
	<?php if( $GLOBALS['ec_cart_data']->cart_data->is_guest == "" ){
		...
		echo "<a href=\"" . $this->account_page . $this->permalink_divider . "ec_page=order_details&order_id=" . $order_id . "&guest_key=" . $GLOBALS['ec_cart_data']->cart_data->guest_key . "\">" . $GLOBALS['language']->get_text( 'cart_success', 'cart_payment_receipt_order_details_link' ) . "</a>";
	}
	?>
