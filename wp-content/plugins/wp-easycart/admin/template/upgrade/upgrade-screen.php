			...
			<div class="ec_admin_list_line_item ec_admin_col_12 ec_admin_col_first">
                ...
                <div class="ec_admin_upgrade_wrap">
                    ...
                    <div class="ec_admin_upsell_popup_extras" style="display:none;" id="ec_admin_upsell_popup_paypal_express">
                        ...
                        <div class="ec_admin_upgrade_subheader ec_admin_upgrade_box_signup_row"><a href="https://www.wpeasycart.com/wordpress-shopping-cart-pricing/?upsell=paypal-express&upsellpage=<?php echo $curr_page; ?>" target="_blank">UPGRADE TO PRO</a></div>
                    ...
                    <div class="ec_admin_upsell_popup_extras" style="display:none;" id="ec_admin_upsell_popup_australia_post">
                        ...
                        <div class="ec_admin_upgrade_subheader ec_admin_upgrade_box_signup_row"><a href="https://www.wpeasycart.com/wordpress-shopping-cart-pricing/?upsell=australia-post&upsellpage=<?php echo $curr_page; ?>" target="_blank">UPGRADE TO PRO</a></div>
                    ...
                    <div class="ec_admin_upsell_popup_extras" style="display:none;" id="ec_admin_upsell_popup_canada_post">
                        ...
                        <div class="ec_admin_upgrade_subheader ec_admin_upgrade_box_signup_row"><a href="https://www.wpeasycart.com/wordpress-shopping-cart-pricing/?upsell=canada-post&upsellpage=<?php echo $curr_page; ?>" target="_blank">UPGRADE TO PRO</a></div>
                    ...
                    <div class="ec_admin_upsell_popup_extras" style="display:none;" id="ec_admin_upsell_popup_dhl">
                        ...
                        <div class="ec_admin_upgrade_subheader ec_admin_upgrade_box_signup_row"><a href="https://www.wpeasycart.com/wordpress-shopping-cart-pricing/?upsell=dhl&upsellpage=<?php echo $curr_page; ?>" target="_blank">UPGRADE TO PRO</a></div>
                    ...
                    <div id="wp_easycart_trial_upsell">                   
						...
						<div class="ec_admin_upgrade_header">Start selling like a PRO, risk-free</div>
						<div class="ec_admin_upgrade_subheader">Start your 14 day FREE Trial of WP EasyCart PRO today at <a href="https://www.wpeasycart.com/wp-easycart-professional-14-no-risk-trial/?upsell=3&upsellpage=<?php echo $curr_page; ?>" target="_blank">www.wpeasycart.com</a>.</div>
						<div class="ec_admin_upgrade_subheader ec_admin_upgrade_box_signup_row"><a href="https://www.wpeasycart.com/wp-easycart-professional-14-no-risk-trial/?upsell=4&upsellpage=<?php echo $curr_page; ?>" target="_blank">GET YOUR FREE PRO TRIAL</a></div>
						
						<div class="ec_admin_upgrade_divider" style="margin-bottom:25px;"><div></div></div>
                    </div>
                    
                    <div class="ec_admin_upgrade_header">Choose Your License</div>
                    
                    <div class="ec_admin_upgrade_subheader" style="margin-bottom:25px">Professional or Premium, choose the plan right for you.</div>
                    ...
                    <div class="ec_admin_upgrade_box_container">
                        ...
                        <div class="ec_admin_upgrade_box ec_admin_upgrade_box_most_popular">
                            ...
                            <div class="ec_admin_upgrade_box_line_item ec_admin_upgrade_box_signup_row"><a href="https://www.wpeasycart.com/wordpress-shopping-cart-pricing/?upsell=5&upsellpage=<?php echo $curr_page; ?>" target="_blank">GET PROFESSIONAL</a></div>
                        ...
                        <div class="ec_admin_upgrade_box">
                            ...
                            <div class="ec_admin_upgrade_box_line_item ec_admin_upgrade_box_signup_row"><a href="https://www.wpeasycart.com/wordpress-shopping-cart-pricing/?upsell=6&upsellpage=<?php echo $curr_page; ?>" target="_blank">GET PREMIUM</a></div>
