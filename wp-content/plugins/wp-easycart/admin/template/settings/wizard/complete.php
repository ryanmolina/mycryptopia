...
<div class="wp_easycart_wizard_success_container">
    ...
    <div class="wp_easycart_wizard_success_box" id="easycart_wizard_demo_data_done" style="display:none;">
        ...
        <div class="wp_easycart_wizard_success_box_right">
            <div class="wp_easycart_wizard_success_box_button"><a href="<?php $storepageid = get_option( 'ec_option_storepage' ); $store_page = get_permalink( $storepageid ); echo $store_page; ?>" style="background:#03A9F4;">View Your Store</a></div>
        </div>
    	<div style="clear:both;"></div>
    </div>
    <?php }?>
    ...
    <div class="wp_easycart_wizard_success_box">
        ...
        <div class="wp_easycart_wizard_success_box_right">
            <div class="wp_easycart_wizard_success_box_button"><a href="admin.php?page=wp-easycart-settings&subpage=cart-importer">Import Products</a></div>
        </div>
    	<div style="clear:both;"></div>
    </div>
    <?php }?>
