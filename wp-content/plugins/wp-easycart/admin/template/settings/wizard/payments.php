...
<div class="ec_admin_wizard_page_row" style="padding:30px 0;">
	<div class="ec_admin_wizard_page_row_title"><strong>PayPal Standard</strong></div>
...
<div id="paypal_standard_content" style="display:none;">
    <div class="ec_admin_wizard_input_row">
        <div class="ec_admin_wizard_input_row_title"><strong>PayPal Email</strong></div>
        <div class="ec_admin_wizard_input_row_input" style="padding:0 5% 0 0;"><input type="text" name="paypal_email" id="wp_easycart_paypal_email" value="<?php echo get_option( 'ec_option_paypal_email' ); ?>" placeholder="youremail@email.com" /></div>
    </div>
</div>
<div class="ec_admin_wizard_page_row" style="padding:30px 0;">
    ...
    <a target="_blank" href="https://support.wpeasycart.com/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=production&goto=wizard' ); ?>&env=production" onclick="return wp_easycart_wizard_use_stripe( );">
		<span></span>
        <label class="ec_admin_wizard_input_row_toggle">
