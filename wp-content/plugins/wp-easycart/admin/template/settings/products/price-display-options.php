<div class="ec_admin_list_line_item">
    ...
    <div class="ec_admin_settings_input ec_admin_settings_products_section">
		...
		<div><input type="checkbox" name="ec_option_tiered_price_format" id="ec_option_tiered_price_format" value="1"<?php if( get_option('ec_option_tiered_price_format') == "1" ){ echo " checked=\"checked\""; }?> /> Tiered Price Format (EX: As Low As $X.XX)</div>
    </div>
