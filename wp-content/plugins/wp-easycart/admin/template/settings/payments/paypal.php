<div class="ec_admin_paypal_row">
    <div class="ec_admin_slider_row">
        ...
        <div class="ec_admin_slider_row_description">
            <div>PayPal Standard gives your customers a payment method that most are comfortable using and does not require an SSL Certificate.</div>
            <div class="ec_admin_slider_row_input"><label for="ec_option_paypal_email">PayPal Email:</label><input type="text" value="<?php echo get_option( 'ec_option_paypal_email' ); ?>" name="ec_option_paypal_email" id="ec_option_paypal_email" placeholder="youremail@site.com" /><input type="button" value="Save" onclick="return ec_admin_save_paypal_options( );" /></div>
        ...
        <div class="ec_admin_toggles_wrap">
            <div class="ec_admin_toggle">
                ...
                <label class="ec_admin_switch">
                    <input type="checkbox" onclick="return paypal_live_on_off( );" class="ec_admin_slider_checkbox" value="1" id="ec_option_paypal_enable_live"<?php if( get_option( 'ec_option_payment_third_party' ) == 'paypal' && !get_option( 'ec_option_paypal_use_sandbox' ) ){ ?> checked="checked"<?php }?>>
            ...
            <div class="ec_admin_toggle">
                ...
                <label class="ec_admin_switch">
                    <input type="checkbox" onclick="return paypal_sandbox_on_off( );" class="ec_admin_slider_checkbox" value="1" id="ec_option_paypal_enable_sandbox"<?php if( get_option( 'ec_option_payment_third_party' ) == 'paypal' && get_option( 'ec_option_paypal_use_sandbox' ) ){ ?> checked="checked"<?php }?>>
                    <span class="ec_admin_slider round"></span>
                </label>
            </div>
        </div>
