<div class="ec_admin_stripe_row">
    <div class="ec_admin_slider_row">
        ...
        <div class="ec_admin_slider_row_description">
            ...
            <?php if( get_option( 'ec_option_stripe_connect_production_access_token' ) != '' ){ ?><a href="admin.php?page=wp-easycart-settings&subpage=payment&ec_admin_form_action=stripe-connect-production-disconnect">Disconnect from Live</a><?php }?><?php if( get_option( 'ec_option_stripe_connect_sandbox_access_token' ) != '' ){ ?><a href="admin.php?page=wp-easycart-settings&subpage=payment&ec_admin_form_action=stripe-connect-sandbox-disconnect">Disconnect from Sandbox</a><?php }?><a href="#" onclick="return stripe_connect_show_advanced( );" id="stripe_connect_advanced_link">Advanced Options &#9660;</a>
        ...
        <div class="ec_admin_toggles_wrap">
            <div class="ec_admin_toggle">
                ...
                <?php if( get_option( 'ec_option_stripe_connect_production_access_token' ) == '' ){ ?>
                <a href="https://support.wpeasycart.com/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=production' ); ?>&env=production">
                <span></span>
				<?php }?>
            ...
            <div class="ec_admin_toggle">
                ...
                <a href="https://support.wpeasycart.com/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=sandbox' ); ?>&env=sandbox">
                <span></span>
				<?php }?>
                <label class="ec_admin_switch">
        ...
        <div id="ec_stripe_connect_options" class="ec_admin_initial_hide">
            <div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show">Currency
            ...
            <div class="ec_admin_settings_input">
                <input type="submit" class="ec_admin_settings_simple_button" onclick="return ec_admin_save_stripe_connect_options( );" value="Save Options" />
            </div>
        </div>
