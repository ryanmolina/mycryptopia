...
if( isset( $_GET['page'] ) && isset( $_GET['subpage'] ) && $_GET['page'] == 'wp-easycart-products' && ( $_GET['subpage'] == 'category' || $_GET['subpage'] == 'category-products' || $_GET['subpage'] == 'category-products-manage' ) )
...
if( isset( $_GET['page'] ) && isset( $_GET['subpage'] ) && $_GET['page'] == 'wp-easycart-products' && ( $_GET['subpage'] == 'option' || $_GET['subpage'] == 'optionitems' ) )
