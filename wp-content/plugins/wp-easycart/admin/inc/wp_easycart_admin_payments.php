...
final class wp_easycart_admin_payments{
	...
	public function disconnect_paypal( ){
		if( $_GET['ec_admin_form_action'] == 'paypal-express-sandbox-disconnect' ){
			...
			$paypal->delete_webhook( get_option( 'ec_option_paypal_sandbox_webhook_id' ) );
			...
			$paypal = new ec_paypal( );
			$paypal->delete_webhook( get_option( 'ec_option_paypal_production_webhook_id' ) );
	...
	public function process_square_app( ){
		...
		}else if( $_GET['ec_admin_form_action'] == 'handle-square' && isset( $_GET['wpeasycart_square_state'] ) && isset( $_SESSION['redirect_security_token'] ) && (int) $_GET['wpeasycart_square_state'] == (int) $_SESSION['redirect_security_token'] ){
...
add_action( 'wp_ajax_ec_admin_ajax_save_square', 'ec_admin_ajax_save_square' );
function ec_admin_ajax_save_square( ){
