...
function ec_admin_save_paypal_options( ){
	...
	if( jQuery( document.getElementById( 'use_paypal' ) ).val( ) == '1' )
		third_party_selected = 'paypal';
	
	var paypal_paynow = '0';
	if( jQuery( document.getElementById( 'ec_option_paypal_enable_pay_now' ) ).val( ) == '1' )
		paypal_paynow = '1';
...
function ec_admin_save_square_options( ){
	...
	var data = {
		action: 'ec_admin_ajax_save_square',
