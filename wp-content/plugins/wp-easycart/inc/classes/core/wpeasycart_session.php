...
class wpeasycart_session{
	...
	public function __construct( ){
		...
		}else if( isset( $_COOKIE['ec_cart_id'] ) ){
	...
	public function handle_session( $session_id = false ){
		...
		// Check Session for New Session Needed
		}else if( isset( $_SESSION['ec_cart_id'] ) &&  $_SESSION['ec_cart_id'] == 'not-set' ){
			$this->new_session( );
