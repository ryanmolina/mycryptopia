...
class ec_db{
	...
	public static function get_total_cart_items_by_product_id( $product_id, $session_id ){
		return self::$mysqli->get_var( self::$mysqli->prepare( "SELECT SUM( ec_tempcart.quantity ) FROM ec_tempcart WHERE ec_tempcart.product_id = %d AND ec_tempcart.session_id = %s AND tempcart.session_id != '' AND tempcart.session_id != 'deleted' AND tempcart.session_id != 'not-set'", $product_id, $session_id ) );
	}
	...
	public static function get_total_cart_items_with_grid_by_product_id( $product_id, $option_id, $session_id ){
		return self::$mysqli->get_var( self::$mysqli->prepare( "SELECT SUM( ec_tempcart_optionitem.optionitem_value ) 
				...
				WHERE ec_tempcart.session_id = %s AND tempcart.session_id != '' AND tempcart.session_id != 'deleted' AND tempcart.session_id != 'not-set'
