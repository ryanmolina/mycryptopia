	...
	function __construct( $product_id_1, $product_id_2, $product_id_3, $product_id_4 ){
		...
		if($product_id_1 || $product_id_2 || $product_id_3 || $product_id_4 ){
			...
			if( !$products ){
				...
				$products = $this->mysqli->get_product_list( $where_statement, $order_statement, "", session_id(), 'wpeasycart-featured-products-'.$product_id_1."-".$product_id_2."-".$product_id_3."-".$product_id_4 );
			}
