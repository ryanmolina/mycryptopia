	...
	*****************************************/
	...
	function get_gateway_data( ){
		...
		$data = array( 
			...
			"dup_seconds"				=> 5,
			"descriptor"				=> $this->user->billing->first_name . " " . $this->user->billing->last_name,
			"descriptor_phone"			=> $this->user->billing->phone,
			"descriptor_address"		=> $this->user->billing->address_line_1,
			"descriptor_city"			=> $this->user->billing->city,
			"descriptor_state"			=> $this->user->billing->state,
			"descriptor_postal"			=> $this->user->billing->zip,
			"descriptor_country"		=> $this->user->billing->country,
