...
class ec_cartpage{
	...
	public function update_authorized_paypal_order( $paypal_response ){
		...
		$GLOBALS['ec_cart_data']->cart_data->billing_first_name = $paypal_response->payer->payer_info->first_name;
		$GLOBALS['ec_cart_data']->cart_data->billing_last_name = $paypal_response->payer->payer_info->last_name;
		$GLOBALS['ec_cart_data']->cart_data->billing_address_line_1 = $paypal_response->payer->payer_info->shipping_address->line1;
		$GLOBALS['ec_cart_data']->cart_data->billing_address_line_2 = $paypal_response->payer->payer_info->shipping_address->line2;
		$GLOBALS['ec_cart_data']->cart_data->billing_city = $paypal_response->payer->payer_info->shipping_address->city;
		$GLOBALS['ec_cart_data']->cart_data->billing_state = $paypal_response->payer->payer_info->shipping_address->state;
		$GLOBALS['ec_cart_data']->cart_data->billing_zip = $paypal_response->payer->payer_info->shipping_address->postal_code;
		$GLOBALS['ec_cart_data']->cart_data->billing_country = $paypal_response->payer->payer_info->shipping_address->country_code;
		$GLOBALS['ec_cart_data']->cart_data->billing_phone = $paypal_response->payer->payer_info->phone;
		
		$GLOBALS['ec_cart_data']->cart_data->shipping_selector = "";
		$GLOBALS['ec_cart_data']->cart_data->shipping_first_name = $paypal_response->payer->payer_info->first_name;
		$GLOBALS['ec_cart_data']->cart_data->shipping_last_name = $paypal_response->payer->payer_info->last_name;
		$GLOBALS['ec_cart_data']->cart_data->shipping_address_line_1 = $paypal_response->payer->payer_info->shipping_address->line1;
		$GLOBALS['ec_cart_data']->cart_data->shipping_address_line_2 = $paypal_response->payer->payer_info->shipping_address->line2;
		$GLOBALS['ec_cart_data']->cart_data->shipping_city = $paypal_response->payer->payer_info->shipping_address->city;
		$GLOBALS['ec_cart_data']->cart_data->shipping_state = $paypal_response->payer->payer_info->shipping_address->state;
		$GLOBALS['ec_cart_data']->cart_data->shipping_zip = $paypal_response->payer->payer_info->shipping_address->postal_code;
		$GLOBALS['ec_cart_data']->cart_data->shipping_country = $paypal_response->payer->payer_info->shipping_address->country_code;
		$GLOBALS['ec_cart_data']->cart_data->shipping_phone = $paypal_response->payer->payer_info->phone;
		
		if( $GLOBALS['ec_user']->user_id == 0 ){
			$GLOBALS['ec_cart_data']->cart_data->email = $paypal_response->payer->payer_info->email;
			$GLOBALS['ec_cart_data']->cart_data->username = $paypal_response->payer->payer_info->first_name . " " . $paypal_response->payer->payer_info->last_name;
			$GLOBALS['ec_cart_data']->cart_data->first_name = $paypal_response->payer->payer_info->first_name;
			$GLOBALS['ec_cart_data']->cart_data->last_name = $paypal_response->payer->payer_info->last_name;
