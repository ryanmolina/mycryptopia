...
?><ul class="repeaters"><?php
	...
	for ( $i = 0; $i <= $count; $i++ ) {
		...
		?><li class="<?php echo esc_attr( $setatts['class'] ); ?>">
			<div class="handle">
				<span class="title-repeater"><?php echo esc_html( $setatts['label-header'], 'live-crypto' ); ?></span>
				<button aria-expanded="true" class="btn-edit" type="button">
					<span class="screen-reader-text"><?php echo esc_html( $setatts['label-edit'], 'live-crypto' ); ?></span>
				...
				<div>
					<a class="link-remove" href="#">
						<span><?php
							...
							echo esc_html( apply_filters( $this->plugin_name . '-repeater-remove-link-label', $setatts['label-remove'] ), 'live-crypto' );
	...
	?><div class="repeater-more">
		...
		<a class="button" href="#" id="add-repeater"><?php
			...
			echo esc_html( apply_filters( $this->plugin_name . '-repeater-more-link-label', $setatts['label-add'] ), 'live-crypto' );
