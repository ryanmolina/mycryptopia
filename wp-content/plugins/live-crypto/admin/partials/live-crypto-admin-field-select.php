...
?><select
	aria-label="<?php esc_attr( _e( $atts['aria'], 'live-crypto' ) ); ?>"
...
if ( ! empty( $atts['blank'] ) ) {
	...
	?><option value><?php esc_html_e( $atts['blank'], 'live-crypto' ); ?></option><?php
...
if ( ! empty( $atts['hideall'] ) ) {
	...
	><?php esc_html_e( $atts['hideall'], 'live-crypto' ); ?></option><?php
