...
// Return list of the featured elements in currency
if ( !function_exists( 'trx_addons_get_list_sc_currency_featured' ) ) {
	function trx_addons_get_list_sc_currency_featured() {
		return apply_filters('trx_addons_filter_get_list_sc_currency_featured', array(
...
// Return list of positions of the featured element in currency
if ( !function_exists( 'trx_addons_get_list_sc_currency_featured_positions' ) ) {
	function trx_addons_get_list_sc_currency_featured_positions() {
		return apply_filters('trx_addons_filter_get_list_sc_currency_featured_positions', array(
			'top' => esc_html__('Top', 'trx_addons'),
			'bottom' => esc_html__('Bottom', 'trx_addons'),
			'left' => esc_html__('Left', 'trx_addons'),
			'right' => esc_html__('Right', 'trx_addons')
...
// Return list of the tabs effects in currency
if ( !function_exists( 'trx_addons_get_list_sc_currency_tabs_effects' ) ) {
	function trx_addons_get_list_sc_currency_tabs_effects() {
		return apply_filters('trx_addons_filter_get_list_sc_currency_tabs_effects', array(
			'fade' => esc_html__('Fade', 'trx_addons'),
