<?php
/**
 * The style "list" of the currency
 *
 * @package WordPress
...
?>
<div class="sc_currency_item without_content<?php
		...
		if ( has_post_thumbnail() && $args['featured']=='image') {
			trx_addons_get_template_part('templates/tpl.featured.php',
											...
											apply_filters('trx_addons_filter_args_featured', array(
																...
																'hover' => 'zoomin',
																'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('medium'), 'currency-list')
																),
															'currency-list'
															)
										);
