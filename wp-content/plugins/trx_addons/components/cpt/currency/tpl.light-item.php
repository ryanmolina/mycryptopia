<?php
/**
 * The style "light" of the currency
 *
 * @package WordPress
		...
		if ( has_post_thumbnail() && $args['featured']=='image') {
			trx_addons_get_template_part('templates/tpl.featured.php',
											...
											apply_filters('trx_addons_filter_args_featured', array(
															...
															'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size($args['columns'] > 2 ? 'medium' : 'big'), 'currency-light'),
			...
			?><a href="<?php echo esc_url($link); ?>"
				 ...
				 class="sc_currency_item_icon <?php
						echo !empty($svg) 
								? 'sc_icon_type_svg'
								: (!empty($img) 
									? 'sc_icon_type_img'
			...
			?><span class="sc_currency_item_number"><?php
				printf("%02d", $number);
			?></span><?php
		}
	}
