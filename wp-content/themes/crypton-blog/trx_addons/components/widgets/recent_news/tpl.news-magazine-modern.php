...
?><article 
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
												'post_info' => '<div class="cat_in_image">'.trx_addons_get_post_categories('').'</div>',
												'thumb_size' => crypton_blog_get_thumb_size($number<=$featured ? 'magazine-modern-big' : 'magazine-modern-small')
	...
	if ($number <= $featured) {
			...
			<div class="post_content entry-content">
				<?php echo wp_html_excerpt(get_the_content(), 210, '...'); ?>
			</div><!-- .entry-content -->
		<?php
	}
?>
