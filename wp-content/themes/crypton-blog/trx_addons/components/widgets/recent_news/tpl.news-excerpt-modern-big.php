...
?><article
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
										'post_info' => '',
										'thumb_size' => crypton_blog_get_thumb_size('magazine-extra')
										), 'recent_news-excerpt')
								);
	?>
	...
	<div class="post_body">
		...
		if ( !in_array($post_format, array('link', 'aside', 'status', 'quote')) ) {
			...
			<div class="post_header entry-header">
				<div class="post_meta"><span class="post_meta_item post_categories"><?php echo trx_addons_get_post_categories(); ?></span></div>
				<?php
				the_title( '<h4 class="post_title entry-title"><a href="'.esc_url(get_permalink()).'" rel="bookmark">', '</a></h4>' );
				if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
					?><div class="post_meta"><span class="post_date post_meta_item"><a href="<?php echo esc_url(get_permalink()); ?>"><?php echo get_the_date(); ?></a></span>
