...
$grid = array(
	...
	array('big', 'medium', 'medium', 'medium', 'medium', 'medium'),
	array('big', 'medium', 'medium', 'medium', 'medium', 'medium', 'medium'),
	array('big', 'medium', 'medium', 'medium', 'medium', 'medium', 'medium', 'medium'),
	array('big', 'medium', 'medium', 'medium', 'medium', 'medium', 'medium', 'medium', 'medium')
);
$thumb_size = $grid[$count-$number >= 9 ? 9 : ($count-1)%9][($number-1)%9];
