...
if (!function_exists('crypton_blog_customizer_get_css')) {

	function crypton_blog_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = crypton_blog_customizer_add_theme_fonts($fonts);
...
.crypton_blog_tabs .crypton_blog_tabs_titles li a {
...
CSS;
			$rez = apply_filters('crypton_blog_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(crypton_blog_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = crypton_blog_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = crypton_blog_customizer_add_theme_colors($colors);
...
.theme_button:focus {
	color: {$colors['inverse_link']} !important;
	background-color: {$colors['text_hover_blend']} !important;
}
...
header .top_header_menu .sc_content_container .vc_row{
...
.sc_layouts_cart.alter .sc_layouts_cart_items_short {
	background-color: {$colors['text_link']};
}
...
.top_panel .scheme_self.vc_row .widget.widget_recent_posts .post_item .post_title a{
	color: {$colors['text_dark']};
}
.top_panel .scheme_self.vc_row .widget.widget_recent_posts .post_item .post_title a:hover{
	color: {$colors['text_link']} !important;
}
.top_panel .scheme_self.vc_row .widget.widget_recent_posts .post_item .post_info .post_info_item a{
	color: {$colors['text']};
}
.top_panel .scheme_self.vc_row .widget.widget_recent_posts .post_item  .post_info .post_info_item a:hover::before,
.top_panel .scheme_self.vc_row .widget.widget_recent_posts .post_item  .post_info .post_info_item a:hover{
	color: {$colors['text_dark']};
}
...
.crypton_blog_tabs .crypton_blog_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.crypton_blog_tabs .crypton_blog_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
body .author_bio .author_link:after {
	color: {$colors['text_link']};
}

/* Related posts */
.related_wrap .related_item_style_2 .post_meta .post_date:before {
	color: {$colors['text_link2']};
}
...
/* Comments */
.comments_list_wrap .comments_list_title:after,
.comments_wrap .comments_form_title:after {
	color: {$colors['text_link']};
}
.comments_list_wrap,
...
.sc_donations_info .sc_donations_button a:after {
	color: {$colors['text_link']};
}
.sc_donations_info .sc_donations_button a:hover {
	color: {$colors['text_link']};
}
...
footer .scheme_self.vc_row .wpb_widgetised_column .widget_fullwidth.widget_banner .image_wrap {
	background-color: {$colors['alter_bg_color']};
}

.top_line .sc_item_title:before {
	background-color: {$colors['text_link']};
}
...
.widget_contacts .socials_wrap .social_item .social_icon:hover {
	color: {$colors['text_link']} !important;
	border-color: {$colors['text_link']};
}
.post_layout_excerpt:not(.sticky) .post_content:after {
	background-color: {$colors['text_dark']};
}

.post_item_single .post_header .post_meta_item.post_date:before,
.post_layout_excerpt.sticky .post_meta_item.post_date:before {
	color: {$colors['text_link2']};
}


.cat_in_image > a,
footer .scheme_self.vc_row .sc_recent_news_style_news-magazine-alter .cat_in_image > a {
	background-color: {$colors['text_link']};
	color: {$colors['inverse_link']};
}
.cat_in_image > a:hover,
footer .scheme_self.vc_row .sc_recent_news_style_news-magazine-alter .cat_in_image > a:hover {
	background-color: {$colors['text_link2']};
	color: {$colors['inverse_link']};
}
...
.sc_layouts_cart_widget .widget_shopping_cart .buttons .button:hover,
.sc_layouts_cart_widget .widget_shopping_cart .buttons .button.checkout:hover {
	background-color: {$colors['text_link']} !important;
	color: {$colors['inverse_link']} !important;
}


.sc_title.color_style_dark.sc_title_default .sc_item_title {
	background-color: {$colors['text_dark']} !important;
	color: {$colors['bg_color']} !important;
}


.sc_recent_news .post_meta_item.post_categories,
.sc_recent_news .post_meta_item.post_categories a {
	color: {$colors['text_link']};
}
.sc_recent_news .post_meta_item.post_categories a:hover {
	color: {$colors['text_dark']};
}

.sc_recent_news .post_layout_news-announce .post_date:before {
	color: {$colors['text_link']} !important;
}
.sc_recent_news .post_layout_news-announce .post_info .post_meta_item:hover:before,
.sc_recent_news .post_layout_news-announce .post_info .post_meta_item:hover *,
.sc_recent_news .post_layout_news-announce .post_info .post_date:hover * {
	color: {$colors['inverse_link']} !important;
}

.sc_recent_news .post_layout_news-announce-alter .post_date:before {
	color: {$colors['text_link']} !important;
}
.sc_recent_news .post_layout_news-announce-alter .post_info .post_meta_item:hover:before,
.sc_recent_news .post_layout_news-announce-alter .post_info .post_meta_item:hover *,
.sc_recent_news .post_layout_news-announce-alter .post_info .post_date:hover * {
	color: {$colors['inverse_link']} !important;
}

.sc_recent_news .post_layout_news-announce-modern .post_date:before {
	color: {$colors['text_link']} !important;
}
.sc_recent_news .post_layout_news-announce-modern .post_info .post_meta_item:hover:before,
.sc_recent_news .post_layout_news-announce-modern .post_info .post_meta_item:hover *,
.sc_recent_news .post_layout_news-announce-modern .post_info .post_date:hover * {
	color: {$colors['inverse_link']} !important;
}
...
.widget_area .post_info .post_info_item a {
	color: {$colors['text']};
}
.widget_area .post_info .post_info_item a:hover {
	color: {$colors['text_dark']};
}
.btc_calculator {
    background-color: {$colors['text_link2']};
...
.trx-date .post_meta .post_date:before {
    color: {$colors['text_link']} !important;
}
...
.searchandfilter ul li:last-child input[type="submit"]:hover{
    background-color: {$colors['text_link']};
}
.searchandfilter ul li .select_container{
    border-color: {$colors['input_bd_color']};	
    background-color: {$colors['alter_bg_color']};
}
...
.tp-caption.home_shop_dscr .trx_addons_list_success_circled li:before,
.home_shop_dscr .trx_addons_list_success_circled li:before{
    color: {$colors['text_dark']};
}
...
.body_style_boxed.extra_boxed .page_content_wrap {
	background: {$colors['bg_color']};
}
.scheme_self.sc_title .sc_item_title {
	color: {$colors['text_dark']};
}
.sc_popup {
	background: {$colors['bg_color']};
...
CSS;
					...
					$rez = apply_filters('crypton_blog_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'crypton_blog_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>